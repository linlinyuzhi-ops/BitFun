...
describe('L1 Settings', () => {
  ...
  describe('Settings panel opening', () => {
    it('settings button should be visible', async function () {
      ...
      const selectors = [
        ...
        '.openbitfun-header-right button',
        '.openbitfun-nav-bar__right button',
      ...
      if (!buttonFound) {
        ...
        const headerContainers = [
          '.openbitfun-header-right',
          '.openbitfun-nav-bar__right',
          '.openbitfun-nav-bar__controls',
          '.openbitfun-nav-bar',
        ];
      ...
      if (!buttonFound) {
        ...
        const header = await $('.openbitfun-nav-bar, .openbitfun-header');
    ...
    it('clicking settings button should open panel', async function () {
      ...
      const panel = await $('.openbitfun-config-center-panel');
  ...
  describe('Settings panel structure', () => {
    ...
    it('settings panel should have content area', async function () {
      ...
      const contentSelectors = [
        '.openbitfun-config-center-content',
  ...
  describe('Configuration modification', () => {
    it('settings should have form inputs', async function () {
      ...
      const inputs = await browser.$$('.openbitfun-config-center-panel input, .openbitfun-config-center-panel select, .openbitfun-config-center-panel textarea');
  ...
  describe('Settings panel closing', () => {
    it('settings panel should be closable', async function () {
      ...
      const backdrop = await $('.openbitfun-config-center-backdrop');
