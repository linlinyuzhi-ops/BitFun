...
impl ScriptsManager {
    ...
    /// - Linux: `~/.cache/openbitfun_terminal/scripts/`
    /// - Windows: `%LOCALAPPDATA%\openbitfun_terminal\scripts\`
    /// - macOS: `~/Library/Caches/openbitfun_terminal/scripts/`
