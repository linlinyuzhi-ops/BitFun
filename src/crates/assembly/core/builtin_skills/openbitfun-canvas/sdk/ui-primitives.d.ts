/**
 * UI primitives for `openbitfun/canvas`. Styling follows the OpenBitFun dark appearance; no extra packages required.
 */
 ...
 * renders a status icon matching `OpenBitFun UI` toasts (override with `icon`).
 *
 * @example
 * ```tsx
