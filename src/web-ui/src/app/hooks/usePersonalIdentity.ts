...
export const DEFAULT_PERSONAL_IDENTITY_NAME = 'BitFun';

export interface PersonalIdentity {
  /** Owner title for the identity badge; falls back to the product brand. */
  displayName: string;
  /** Companion pet selected in Settings > Personalization (built-in pet fallback). */
  pet: AgentCompanionPetSelection;
}

/** Reactive personal-identity facts from Settings > Personalization. */
