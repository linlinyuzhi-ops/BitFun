...
const SHORTCUT_NAME: &str = "OpenBitFun.lnk";
const NESTED_START_MENU_DIR: &str = "OpenBitFun";

/// Create a desktop shortcut for OpenBitFun.
...
/// Create a Start Menu shortcut for OpenBitFun.
